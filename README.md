...
To see how to run Hemp0x, please read the respective files in [the doc folder](doc)
...
Hemp Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
Developer IRC is inactive please join us on discord in #development. https://discord.gg/Eu4UsYPMGS
...
Hemp0x is designed to be a use case specific blockchain designed to efficiently handle one specific function: the transfer of assets from one party to another.

Bitcoin is and always should be focused on its goals of being a better form of money. Bitcoin developers will unlikely prioritize improvements or features which are specifically beneficial to the facilitation of token transfers.  One goal of the Hemp0x project is to see if a use case specific blockchain and development effort can create code which can either improve existing structures like Bitcoin or provide advantages for specific use cases.
