...
"""
    ...
    Hemp0x should be started with the command line arguments:
        hemp0xd -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND HEMP issuance at " + str(pos))
				print("After HEMP: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND HEMP something at " + str(pos))
			start += pos+8
			print(astr)
