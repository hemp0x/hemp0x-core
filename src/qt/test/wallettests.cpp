...
#include "qt/hemp0xamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<Hemp0xAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_hemp0x-qt -platform xcb      # Linux
//     src/qt/test/test_hemp0x-qt -platform windows  # Windows
//     src/qt/test/test_hemp0x-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = Hemp0xUnits::formatWithUnit(unit, balance, false, Hemp0xUnits::separatorAlways);
    ...
    // Amount input
    Hemp0xAmountField* amountInput = receiveCoinsDialog.findChild<Hemp0xAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: hemp0x:")) != -1);
