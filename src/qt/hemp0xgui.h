...
#ifndef HEMP0X_QT_HEMP0XGUI_H
#define HEMP0X_QT_HEMP0XGUI_H
...
/**
  Hemp0x GUI main class. This class represents the main window of the Hemp0x UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class Hemp0xGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit Hemp0xGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~Hemp0xGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a hemp0x wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
