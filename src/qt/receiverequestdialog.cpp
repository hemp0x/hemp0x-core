...
#include "config/hemp0x-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatHemp0xURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + Hemp0xUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatHemp0xURI(info));
}
