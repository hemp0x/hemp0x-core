...
#ifndef HEMP0X_QT_HEMP0XUNITS_H
#define HEMP0X_QT_HEMP0XUNITS_H
...
/** Hemp0x unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class Hemp0xUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit Hemp0xUnits(QObject *parent);
...
typedef Hemp0xUnits::Unit Hemp0xUnit;

#endif // HEMP0X_QT_HEMP0XUNITS_H
