...
#ifndef HEMP0X_QT_GUIUTIL_H
#define HEMP0X_QT_GUIUTIL_H
...
/** Utility functions used by the Hemp0x Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "hemp0x:" URI into recipient object, return true on successful parsing
