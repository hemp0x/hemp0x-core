...
#ifndef HEMP0X_SCRIPT_STANDARD_H
#define HEMP0X_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_HEMP0X_ASSET script that carries data
    /** HEMP END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a hemp0x address
 */
...
/**
 * Generate a Hemp0x scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // HEMP0X_SCRIPT_STANDARD_H
