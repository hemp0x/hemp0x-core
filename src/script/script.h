...
#ifndef HEMP0X_SCRIPT_SCRIPT_H
#define HEMP0X_SCRIPT_SCRIPT_H
...
public:
    ...
    bool GetOp2(const_iterator& pc, opcodetype& opcodeRet, std::vector<unsigned char>* pvchRet) const
    {
        ...
        // If we see an op hemp asset, we consider all data after it has data, and not op codes
        // Move the pc to the end of the script
        if (opcode == OP_HEMP_ASSET) {
    ...
    /**
     * Pre-version-0.6, Hemp0x always counted CHECKMULTISIGs
