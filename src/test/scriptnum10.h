...
#ifndef HEMP0X_TEST_SCRIPTNUM10_H
#define HEMP0X_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hemp0x Core 0.10.0, for cross-comparison.
 */
public:
