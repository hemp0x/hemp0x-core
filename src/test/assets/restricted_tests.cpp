...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler hemp tx
        CScript hempTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut hempOut(1*COIN, hempTransfer);
        ...
        mutTxTest1.vout.emplace_back(hempOut);
        ...
        mutTxTest2.vout.emplace_back(hempOut);
        ...
        mutTxTest3.vout.emplace_back(hempOut);
        ...
        mutTxTest4.vout.emplace_back(hempOut);
        ...
        mutTxTest5.vout.emplace_back(hempOut);
        ...
        mutTxTest6.vout.emplace_back(hempOut);
        ...
        mutTxTest7.vout.emplace_back(hempOut);
        ...
        mutTxTest8.vout.emplace_back(hempOut);
