...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the Hemp0xTestFramework
    pass

class ExampleTest(Hemp0xTestFramework):
    # Each functional test is a subclass of the Hemp0xTestFramework class.
    ...
    def custom_method(self):
        ...
        Hemp0xTestFramework class so other tests can use it."""
