...
import os
import struct
from test_framework.test_framework import Hemp0xTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(Hemp0xTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that hemp0x has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("hemp0xd has not been built with zmq enabled.")
