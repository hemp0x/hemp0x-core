...
class BIP66Test(Hemp0xTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # hemp0xd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and hemp0xd produces more specific reject
            # reasons.
