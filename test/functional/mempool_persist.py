...
By default, hemp0xd will dump mempool on shutdown and
...
class MempoolPersistTest(Hemp0xTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give hemp0xd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent hemp0xd from writing mempool.dat to disk. Verify that `savemempool` fails")
