...
class AssetTest(Hemp0xTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("HEMP0X1", 1000)
        n0.issue("HEMP0X2", 1000)
        n0.issue("HEMP0X3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="HEMP0X*", verbose=False, count=2, start=-2)
        ...
        hemp0x_assets = n0.listassets(asset="HEMP0X*", verbose=False, count=2, start=-2)
        assert_equal(len(hemp0x_assets), 2)
        assert_equal(hemp0x_assets[0], "HEMP0X2")
        assert_equal(hemp0x_assets[1], "HEMP0X3")
        self.sync_all()
