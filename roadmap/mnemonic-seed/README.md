...
A command-line option (-noseed) can be passed when starting hemp0xd and/or hemp0x-qt for the first time to create a wallet using the original key system that existed in Bitcoin and Hemp0x on Jan 3, 2019.
