...
2.  Build hemp0x-core:
    ...
    Configure and build the headless hemp0x binaries as well as the GUI (if Qt is found).
...
------------------------
You can use Qt Creator as an IDE, for hemp0x development.
...
4. Enter "hemp0x-qt" as project name, enter src/qt as location
