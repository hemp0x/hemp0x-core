...
This document provides guidelines for internationalization of the Hemp0x Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hemp0x_en.ts` remains unchanged.
